...
"[project]/Downloads/Learnix/LearnixFinal/app/educator/[username]/upload-quiz/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UploadQuiz() {
    ...
    const [maxMarks, setMaxMarks] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Learnix$2f$LearnixFinal$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Learnix$2f$LearnixFinal$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UploadQuiz.useEffect": ()=>{
            if (!username) return;
            fetch(`/api/users?username=${username}`).then({
                "UploadQuiz.useEffect": (r)=>r.json()
            }["UploadQuiz.useEffect"]).then({
                "UploadQuiz.useEffect": (d)=>setUserId(d._id)
            }["UploadQuiz.useEffect"]);
        }
    }["UploadQuiz.useEffect"], [
        username
...
_s(UploadQuiz, "YxwplvWYdz9y63cMGtLV9NzB+Bw=", false, function() {
    return [
...
_c = UploadQuiz;
var _c;
__turbopack_context__.k.register(_c, "UploadQuiz");
...
//# sourceMappingURL=Downloads_Learnix_LearnixFinal_89c09bc2._.js.map