...
"[project]/Downloads/Learnix/LearnixFinal/app/educator/[username]/upload-notes/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UploadNotes() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Learnix$2f$LearnixFinal$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UploadNotes.useEffect": ()=>{
            if (!username) return;
            fetch(`/api/users?username=${username}`).then({
                "UploadNotes.useEffect": (res)=>res.json()
            }["UploadNotes.useEffect"]).then({
                "UploadNotes.useEffect": (data)=>setUserId(data._id)
            }["UploadNotes.useEffect"]);
        }
    }["UploadNotes.useEffect"], [
        username
...
_s(UploadNotes, "GGaRZ7IgxkC3SbZWLI1gHUM94fM=", false, function() {
    return [
...
_c = UploadNotes;
var _c;
__turbopack_context__.k.register(_c, "UploadNotes");
...
//# sourceMappingURL=Downloads_Learnix_LearnixFinal_bfc53529._.js.map